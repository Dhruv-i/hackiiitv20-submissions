...
CREATE TABLE `hospital_details` (
  ...
  `booked_bed` int DEFAULT NULL,
  `adhar_card` bigint DEFAULT NULL,
  `juniar_doctors_name` varchar(100) DEFAULT NULL,
  `doctors_name` varchar(100) DEFAULT NULL,
  `workers_name` varchar(100) DEFAULT NULL,
...
-- Dump completed on 2020-12-12  0:58:20
